...
public class DirectorAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    Context context;
    List<XiangQingBean.ResultBean.MovieDirectorBean> movieDirector;


    public DirectorAdapter(Context context, List<XiangQingBean.ResultBean.MovieDirectorBean> movieDirector) {
